...
saving = quandl.get("FRED/PSAVERT", start_date="1990-01-01", authtoken="API_KEY")  # Import data using API call and applicable rules
jobs = quandl.get("FRED/UNRATE", start_date="1990-12-31", end_date="2018-03-01", authtoken="API_KEY")
